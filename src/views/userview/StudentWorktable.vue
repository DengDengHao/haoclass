...
<a-card style="width:100%;">
 <a-descriptions title="用户信息">
    ...
    <a-descriptions-item label="学生用户名">{{teachername}}</a-descriptions-item>
    <a-descriptions-item label="学生编号">{{teacherindex}}</a-descriptions-item>
  </a-descriptions>
  </a-card>
...
message.info('删除未保存的图片！')
    ...
    fordata.jiu=b.join(''); */
      ...
      axios.post('/uploadimage/dels',qs.stringify(fordata)).then(res=>{
              if(res.data=='100'){
                  message.info('您成功更新')
                  reload()
              }
