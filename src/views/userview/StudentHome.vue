  ...
  <a-layout class="mainlayout">
    <a-layout-sider v-model:collapsed="collapsed" :trigger="null" collapsible>
      ...
      <a-menu :selectedKeys="[$route.path]" theme="dark" mode="inline" @click="jumpmenu">
        <a-menu-item key='/studentsign'>
          <video-camera-outlined />
          <span>课程报名</span>
        </a-menu-item>
        <a-menu-item key='/studentbook'>
          <upload-outlined />
          <span>课程预约</span>
        </a-menu-item>
        <a-menu-item key='/studentworktable'>
          <user-outlined />
          <span>个人中心</span>
        </a-menu-item>
      </a-menu>
    ...
    <a-layout>
      <a-layout-header style="background: #fff; padding: 15">
...
logout(){
  ...
  setup() {
    ...
    return {
      ...
      selectedKeys: ref(['1']),
      collapsed: ref(false),
      menulist:['/studentworktable','/studentsign','/studentbooking']
    };
  },
